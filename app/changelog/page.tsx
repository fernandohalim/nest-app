        ...
        <div className="space-y-5 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-1/2 before:h-full before:w-1 before:bg-linear-to-b before:from-emerald-300 before:via-stone-200 before:to-stone-100 before:rounded-full">
          {releases.map((release, index) => {
            ...
            if (weight === 1) {
              ...
              Node = (
                <div
                  className="flex items-center justify-center w-5 h-5 rounded-full border-[3px] border-[#fdfbf7] bg-stone-300 relative z-10 group-hover:bg-sky-400 group-hover:scale-125 transition-all mt-2.5"
                  aria-hidden="true"
                ></div>
              );
            }
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  aria-expanded={weight === 3 ? Boolean(isExpanded) : undefined}
                  onKeyDown={
                    weight === 3
                      ? (e) => {
                  ...
                  className={`flex-1 transition-all group-hover:-translate-y-1 ${
                    ...
                    weight === 1
                      ? "p-6 rounded-4xl bg-white border-2 border-stone-300 shadow-lg hover:shadow-xl hover:border-emerald-500"
                      : weight === 2
                        ? "p-5 rounded-3xl bg-white border-2 border-stone-100 shadow-sm hover:shadow-md hover:border-emerald-200"
                        : "p-4 rounded-2xl bg-white/50 border border-stone-100/80 shadow-sm hover:bg-white hover:border-stone-200"
                  }`}
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {weight === 3 && (
                        <svg
                          ...
                          aria-hidden="true"
                        >
                          {/* 🔥 U6: was `M19 9l-7 7-7 7` (Z-shape). correct chevron: `M19 9l-7 7-7-7`. */}
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            strokeWidth={3}
